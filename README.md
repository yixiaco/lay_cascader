...
| 选项名称 | 说明                   | 类型                  | 示例                                  |
| -------- | ---------------------- | --------------------- | ------------------------------------- |
| value    | 指定选项的值           | String、Number、Array | '1'、1、[1]、[[1,2],[1,3]]            |
| label    | 指定选项标签           | String                | '广东'                                |
| children | 指定选项的子选项       | Array<Option>         | [{label: '广东', value: 'guangdong'}] |
| disabled | 指定选项是否禁用       | Boolean               | true                                  |
| leaf     | 指定选项是否是叶子节点 | Boolean               | true                                  |
